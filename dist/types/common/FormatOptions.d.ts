...
export type FormatOptions = IArrayFormatOptions | ICsvFormatOptions | IHtmlFormatOptions | IJsonFormatOptions | IJsonListFormatOptions | IMarkdownFormatOptions | ITableFormatOptions | ITextFormatOptions | IXmlFormatOptions | IYamlFormatOptions;
export declare const isCsvFormatOptions: (item: ICsvFormatOptions) => item is ICsvFormatOptions;
export declare const isFormatOptions: (item: ICsvFormatOptions) => item is ICsvFormatOptions;
